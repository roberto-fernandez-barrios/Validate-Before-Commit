...
- **Fig. 1** regime spectrum · **Fig. 2** mechanism law (r=−0.89) · **Fig. 3** oracle-regret vs harm-frequency · **Fig. 4** the gate (both detectors) · **Fig. 5** label-efficiency frontier (probe budget 8–128) · **Fig. 6** generalization across four downstream classifiers (harm is SVC-specific; gate safe everywhere).

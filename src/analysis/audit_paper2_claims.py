...
def main():
    ...
    check("5.1 UNSW Recon gain +0.3", 0.3, val(spect, "best_gain_BA_pts", regime_id="unsw_recon"), 0.06)
    check("5.1 ToN best adaptive -0.6", -0.6, val(spect, "best_gain_BA_pts", regime_id="ton_iot_scanning"), 0.06)
    check("5.1 ToN worst adaptive -4.5", -4.5, val(spect, "worst_gain_BA_pts", regime_id="ton_iot_scanning"), 0.06)
    check("5.1 DDoS F1 gain +32.3", 32.3, val(spect, "best_gain_F1_pts", regime_id="cicids_ddos"), 0.06)
    check("5.1 ToN Energy F1 -0.8", -0.8, val(baf1, "gain_F1_pts", regime_id="ton_iot_scanning", method="energy_distance"), 0.06)
    check("5.1 ToN KS F1 -9.5", -9.5, val(baf1, "gain_F1_pts", regime_id="ton_iot_scanning", method="ks_max"), 0.06)
    ...
    check("5.2 r pooled -0.82", -0.82, r_pool, 0.006)
    ...
    check("5.2 ToN no-adapt 92.0%", 92.0, val(spect, "noadapt_BA", regime_id="ton_iot_scanning") * 100, 0.06)
    ...
    check("5.2 ToN QK regret 3.50", 3.50, val(regret, "regret_pts", regime_id="ton_iot_scanning", detector="qk_mmd_zz"), 0.006)
    check("5.2 ToN QK regret CI lo 0.96", 0.96, val(regret, "regret_ci_lo", regime_id="ton_iot_scanning", detector="qk_mmd_zz"), 0.006)
    check("5.2 ToN QK regret CI hi 7.45", 7.45, val(regret, "regret_ci_hi", regime_id="ton_iot_scanning", detector="qk_mmd_zz"), 0.006)
    check("5.2 ToN QK harm 80%", 80.0, val(regret, "harm_seed_pct", regime_id="ton_iot_scanning", detector="qk_mmd_zz"), 0.1)

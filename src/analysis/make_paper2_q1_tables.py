...
the incumbent collapses (CICIDS), the gates preserve part of always-deploying's recovery
but can impose substantial costs; where the incumbent stays healthy, point estimates for
point and strict gates are \\emph{{above}} always-deploying on both UNSW
timelines (VBC-SG on the 20\\% split but not the 40\\%), with the healthy Wednesday intra-day
replay the unresolved counterexample. These are descriptive comparisons, not direct
